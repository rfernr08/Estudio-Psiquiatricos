...
traducir_codigos_a_descripcion('TFG/dataset/diagnosticos_limpios/diagnosticos_unidos.csv', 'TFG/dataset/Conversor_Definitivo.csv', 'dataset_descripciones.csv')